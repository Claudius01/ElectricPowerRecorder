...
2. Convertisseur AC/DC avec son câble d'interface de 3 broches (3V3 + Masse + sortie analogique)
3. Connecteur JST-SH1.0 femelle 4 broches pour l'alimentation en 3V3 + Masse du convertisseur AC/DC + entrée analogique
